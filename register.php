...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="register.php" method="POST">
            ...
            <button type="submit" class="w-full bg-black text-white py-2 rounded-lg hover:bg-gray-800 transition duration-300">Registrarse</button>
        </form>
        <p class="mt-6 text-center text-gray-700">¿Ya tienes una cuenta? <a href="login.php" class="text-blue-600 hover:underline">Inicia Sesión</a></p>
    </div>
</body>
</html>